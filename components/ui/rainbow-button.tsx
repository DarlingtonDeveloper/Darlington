...
// Base classes for the rainbow button
const BASE_BUTTON_CLASSES = [
    "group relative inline-flex h-11 cursor-pointer",
    "items-center justify-center rounded-xl",
    "border-0 bg-[length:200%] px-8 py-2 font-medium text-white",
    "transition-colors [background-clip:padding-box,border-box,border-box]",
    "animate-rainbow",
...
export function RainbowButton({
    ...
    return (
        <button
            ...
            style={{ "--speed": animationSpeed } as React.CSSProperties}
            {...props}
        >
            {children}
        </button>
