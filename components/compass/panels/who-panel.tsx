...
const TRAJECTORY = [
  {
    ...
    href: "https://www.coxautoinc.eu",
    desc: "Serverless remittance. EventBridge, Lambda, Open Banking, SEPA. Introduced Claude AI agents with MCP tools across microservices.",
    current: true,
  },
  {
    year: "2022",
    ...
    desc: ".NET 9, GraphQL, CosmosDB. Led 8 developers across four contract-driven microservices. Reduced production incidents 85%.",
    current: false,
  },
  {
    year: "2021",
    ...
    desc: "Cross-cloud Kubernetes on Azure & AWS. Python LLM chatbot. Go observability tooling. Terraform IaC — onboarding from 2 weeks to 2 days.",
    current: false,
  },
  {
    year: "2020",
    role: "Cloud Software Engineer",
    company: "Cloud Design Box",
    href: "https://clouddesignbox.co.uk",
    desc: "GPT-3 tutor chatbot serving 1M+ students. Real-time collaborative whiteboard. <100ms sync nationwide.",
    current: false,
  },
  {
    year: "2018",
    role: "Full-Stack Developer",
    company: "LabLogic Systems",
    href: "https://lablogic.com",
    desc: "ISO 9001-compliant nuclear medicine backend. C#, SQL Server. Systems can be life-critical.",
    current: false,
  },
  {
    year: "2015",
    role: "BSc Computer Science (First Class)",
    company: "Hull University",
    desc: "Machine vision weather prediction. Natural language to C compiler.",
    current: false,
  },
];
...
const REPOS = [
  {
    name: "MissionControl",
    lang: "Go",
    href: "https://github.com/DarlingtonDeveloper/MissionControl",
  },
  {
    name: "MindMap",
    lang: "TypeScript",
    href: "https://github.com/DarlingtonDeveloper/MindMap",
  },
  {
    name: "ArchAngel",
    lang: "Go",
  ...
  },
  {
    name: "oru-backend",
    lang: "TypeScript",
    href: "https://github.com/DarlingtonDeveloper/oru-backend",
  },
  {
    name: "type-persona-link",
    lang: "TypeScript",
    href: "https://github.com/DarlingtonDeveloper/type-persona-link",
  },
  {
    name: "ConnectFourRL",
    lang: "Python",
  ...
  {
    name: "Technical_Analysis_Plotter",
    lang: "Python",
...
export function WhoPanel() {
  ...
  const filteredRepos =
    langFilter === "All" ? REPOS : REPOS.filter((r) => r.lang === langFilter);
      ...
      >
        ...
        <motion.div className="space-y-3 shrink-0" variants={fadeUp}>
          ...
          <p className="text-[14px] leading-relaxed text-[var(--fg2)] max-w-[600px]">
            Lead Backend Engineer designing cloud-native architectures,
            event-driven microservices, and scalable platforms across Azure and
            AWS. Polyglot developer — C#, Go, Python, Java, Rust.{" "}
            <a
              href="#"
                      ...
                      <div>
                        ...
                        <div className="flex gap-1.5 mt-1">
                          {site.tech.map((t) => (
                            <span
                              key={t}
                              className="font-mono text-[10px] text-[var(--fg2)] bg-white/5 px-1.5 py-0.5 rounded"
                            >
                              {t}
                            </span>
                          ))}
                ...
                {filteredRepos.map((repo) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-[10px] text-[var(--fg2)]">
                        {repo.lang}
                      </span>
                    </div>
