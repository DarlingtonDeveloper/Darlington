...
const WhoPanel = dynamic(
  () => import("./panels/who-panel").then((m) => m.WhoPanel),
  { ssr: false },
);
const HowPanel = dynamic(
  () => import("./panels/how-panel").then((m) => m.HowPanel),
  { ssr: false },
);
const WhatPanel = dynamic(
  () => import("./panels/what-panel").then((m) => m.WhatPanel),
  { ssr: false },
);
const WhyPanel = dynamic(
  () => import("./panels/why-panel").then((m) => m.WhyPanel),
  { ssr: false },
);
    ...
    <div className="fixed inset-0 bg-[var(--bg)] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 50% 65%, rgba(196, 181, 160, 0.04) 0%, transparent 70%)",
          }}
        />
      </div>
