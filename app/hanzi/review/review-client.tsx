...
export function ReviewClient({
  ...
  return (
    <div className="px-4 pb-safe sm:px-6 sm:max-w-2xl sm:mx-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          {!isSentenceMode && (
            <button
              ...
              className="flex items-center justify-center size-7 rounded-lg text-neutral-500 hover:text-neutral-300 hover:bg-neutral-800 transition-colors"
      ...
      {/* Review Settings Modal (only for words mode) */}
      {!isSentenceMode && (
        <ReviewSettingsModal
          isOpen={showSettings}
