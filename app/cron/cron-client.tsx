...
export function CronClient() {
  ...
  useEffect(() => {
    fetchJobs(); // eslint-disable-line react-hooks/set-state-in-effect -- fetch on mount
  }, [fetchJobs]);
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      <Zap
                        className={`w-3.5 h-3.5 flex-shrink-0 ${job.enabled ? "text-emerald-400" : "text-neutral-600"}`}
                      />
                ...
                <div className="flex items-center gap-3 mt-2 ml-5.5 text-xs text-neutral-500">
                  ...
                  {job.state?.nextRunAtMs && (
                    <span className="flex items-center gap-1">
                      ...
                      Next:{" "}
                      {format(new Date(job.state.nextRunAtMs), "EEE HH:mm")}
                    </span>
                  )}
                </div>
              </div>
              ...
              return (
                ...
                >
                  ...
                  {runs.length > 0 ? (
                    ...
                    <p className="ml-11 text-xs text-neutral-700">
                      No scheduled runs
                    </p>
                  )}
                </div>
